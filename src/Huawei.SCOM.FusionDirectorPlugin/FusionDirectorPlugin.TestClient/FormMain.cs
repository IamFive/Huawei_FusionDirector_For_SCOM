...
namespace FusionDirectorPlugin.TestClient
{
	...
	'Slot': {
        ...
        private void btnInsertServerEvent_Click(object sender, EventArgs e)
        {
            ...
            var alarmData = new EventData(pushData.Data, "112.93.129.30");
  ...
  'Group': null,
  'IPv4Address': {
    'Address': '112.93.129.120',
    'AddressOrigin': '',
    'GateWay': '',
    'SubnetMask': '',
    'PrefixLength': null
  },
  'IPAddress': '112.93.129.120',
  'BiosVersion': '0.95',
  'PowerState': 'On',
  'ServerState': 'OnLine',
  'Processors': [{
    ...
    'UnionId': '112.93.129.30-1c296d11-7ae3-484f-921d-3f430a1e2352',
    'FusionDirectorIp': '112.93.129.30',
    ...
    'UnionId': '112.93.129.30-301b2758-9999-4c3f-b055-4a4c3f1c23aa',
    'FusionDirectorIp': '112.93.129.30',
    ...
    'UnionId': '112.93.129.30-bada5611-03e0-4ebf-8807-40b2852388d7',
    'FusionDirectorIp': '112.93.129.30',
  ...
  'Memorys': [{
    ...
    'UnionId': '112.93.129.30-17d3fd39-209b-48ad-961c-e09e201b206b',
    'FusionDirectorIp': '112.93.129.30',
    ...
    'UnionId': '112.93.129.30-d80b75b8-f130-4804-a67e-959630866efa',
    'FusionDirectorIp': '112.93.129.30',
    ...
    'UnionId': '112.93.129.30-e586de70-a567-49bf-92b6-5952ac9d24a0',
    'FusionDirectorIp': '112.93.129.30',
  ...
  'NetworkAdapters': [{
    ...
    'UnionId': '112.93.129.30-f5241c52-75de-44ef-805e-c2e272a7bdf7',
    'FusionDirectorIp': '112.93.129.30',
    'Id': 'mainboardMEZZ1',
    ...
    'UnionId': '112.93.129.30-d04492e0-1ec2-4725-9ec4-c01e067ba41b',
    'FusionDirectorIp': '112.93.129.30',
    'Id': 'mainboardMEZZ2',
    ...
    'UnionId': '112.93.129.30-fea66688-5254-499b-baf4-27a033ec7eab',
    'FusionDirectorIp': '112.93.129.30',
    'Id': 'mainboardMEZZ3',
    ...
    'UnionId': '112.93.129.30-bdf837fa-db04-48ff-a3be-391aefa0b2a8',
    'FusionDirectorIp': '112.93.129.30',
    'Id': 'mainboardMEZZ4',
  ...
  'RaidCards': [{
    ...
    'Name': 'RAIDStorage0',
    'StorageControllers': [{
      'UnionId': '112.93.129.30-5d88cbc6-6a0c-45ab-bedc-39398fdd87c8-RAIDCard1Controller',
  ...
  'Drives': [{
    ...
    'UnionId': '112.93.129.30-d4fdf8b0-e723-4095-9a72-0e5b9c8bd07a',
    'FusionDirectorIp': '112.93.129.30',
    '@odata.context': '/redfish/v1/rich/$metadata#NodePoolService.NodePoolService',
    ...
    'UnionId': '112.93.129.30-94eadd0f-cfbe-4784-8347-e1f8918d19f1',
    'FusionDirectorIp': '112.93.129.30',
    '@odata.context': '/redfish/v1/rich/$metadata#NodePoolService.NodePoolService',
...
";
      ...
      'Members@odata.count': 3
        ...
        {
            //ServerConnector.Instance.CheckUnclosedAlert("112.93.129.103", new List<string>() { "666", "667" });
